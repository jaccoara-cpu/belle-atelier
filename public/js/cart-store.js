...
Object.assign(BelleStore, {
  ...
  getDefaultSiteTexts() {
    return {
      ...
      // Cart Measurements Advisory Notice
      cart_advisory_title: 'Введіть будь ласка ваші мірки для кожного виробу, щоб ми перевірили правильність підібраного розміру',
      cart_advisory_text: '❗ Якщо в кошику додано декілька виробів (наприклад, чоловічий та жіночий одяг), заповніть індивідуальні мірки для кожного з них окремо. За необхідності наш стиліст зв\'яжеться з вами для уточнення.'
    };
  },
